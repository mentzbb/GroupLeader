...
The community group leader is a very consistent conversationalist who always responds the 
same way to conversation starters. 


## Taking the Challenge

To take the challenge you build out the GroupLeader.cls class to satisfy the unit tests. There are a couple of ways of doing this.
...
`sfdx force:mdapi:deploy -l RunSpecifiedTests -r GroupLeader_Test -c -u <username> -d src -w 10 `
